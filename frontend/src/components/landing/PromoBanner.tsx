  ...
  return (
    <section className="py-10" aria-label="Promotion">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6 rounded-3xl border border-champagne/25 bg-gradient-to-br from-blush-light via-blush to-champagne/20 p-8 shadow-sm sm:flex-row sm:justify-between">
          <div className="flex items-center gap-5">
            <GradientIcon size="lg">
              <GiftIcon />
            </GradientIcon>
            <div>
              <span className="text-xs font-semibold uppercase tracking-widest text-champagne-dark">
                Special Offer
              </span>
              {promo ? (
                <>
                  <h3 className="mt-1 font-display text-xl font-bold text-charcoal sm:text-2xl">
                    {formatDiscount(promo)} with code {promo.code}
                  </h3>
          ...
          <Link
            to="/book"
            className="inline-flex shrink-0 items-center justify-center rounded-full bg-rosegold-gradient px-8 py-3 text-sm font-semibold text-white shadow-md transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
          >
